...
<head>
    ...
    <title>Iniciar Sesión | {{ config('app.name', 'Mi Tienda SaaS') }}</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ url('/') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">MiTienda</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">¡Bienvenido a tu SaaS! 👋</h4>
                        <p class="mb-4">Inicia sesión con tus credenciales para administrar la plataforma</p>
